...
from app.modules.agent_runtime.admin_router import router as admin_agent_runtime_router
...
from app.modules.finance.router import admin_router as admin_finance_router
...
from app.modules.messaging.router import admin_ai_router as admin_ai_messaging_router
...
api_router.include_router(admin_agent_runtime_router)
...
api_router.include_router(admin_ai_messaging_router)
