...
SOURCE_SHA256 = "d58ba339bcda331b5e909f1f5b860841e8e487a7096624ad3c241a4930bf1c51"
OPERATIONS: dict[str, dict[str, object]] = {
    ...
    "AdminInventory_Adjust": {
        ...
        "x-test-case-ids": ["ADM-INV-*", "ADM-PRODUCT-*", "MCH-PORTAL-*"],
    },
    "AdminInventory_Get": {
    ...
    "AdminProduct_List": {
        ...
        "x-scope-policy": ["stores:read", "products:read", "store_scope"],
        "x-test-case-ids": ["ADM-PRODUCT-*", "MCH-PORTAL-*"],
    },
    ...
    "AdminReview_List": {
        ...
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["reviews:read"],
        "x-requirement-id": ["ADM-REVIEW-LIST-01", "MCH-REVIEW-LIST-01"],
    ...
    "AdminShippingTemplate_List": {
        ...
        "x-test-case-ids": ["ADM-INV-*", "ADM-PRODUCT-*", "ADM-STORE-*", "MCH-PORTAL-*"],
    },
    ...
    "SupportTicket_List": {
        ...
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["support:queue_read"],
        "x-requirement-id": ["ADM-SUPPORT-LIST-01", "MCH-SHELL-01", "MCH-SUPPORT-LIST-01"],
        "x-scope-policy": [
            "store_operator_with_store_scope",
            "merchant_exclusive_conversation_owner",
            "store_queue_scope",
