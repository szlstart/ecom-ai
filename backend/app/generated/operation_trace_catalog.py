...
OPERATIONS: dict[str, dict[str, object]] = {
    ...
    "AdminAiConversation_DeleteMine": {
        ...
        "x-domain-command": "AdminAiConversation_DeleteMine",
        "x-idempotency-policy": "http_method_idempotent",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
    ...
    "AdminAiConversation_PutMine": {
        ...
        "x-permission-codes": [],
        "x-requirement-id": ["ADM-MSG-01", "GLOBAL-ADMIN-AI-CHAT-01"],
        "x-scope-policy": [
            "support:queue_read",
            "support:claim",
            "support:reply",
    ...
    "AdminOrder_Get": {
        ...
        "x-requirement-id": ["ADM-ORDER-01", "MCH-ORDER-01"],
        "x-scope-policy": [
            "stores:read",
            "orders:read",
            "shipments:create",
    ...
    "AdminProductFaq_Replace": {
        ...
        "x-domain-command": "AdminProductFaq_Replace",
        "x-idempotency-policy": "if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["products:update"],
        "x-requirement-id": ["ADM-PRODUCT-01", "ADM-STORE-PRODUCT-EDIT-01", "MCH-PRODUCT-EDIT-01"],
    ...
    "AdminProduct_Delete": {
        ...
        "x-domain-command": "AdminProduct_Delete",
        "x-idempotency-policy": "idempotency_key_required+if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["products:update"],
        "x-requirement-id": ["ADM-STORE-DETAIL-01", "MCH-PRODUCT-LIST-01"],
    ...
    "AdminRefund_Claim": {
        ...
        "x-requirement-id": ["ADM-REFUND-01", "MCH-REFUND-01"],
        "x-scope-policy": ["refunds:read", "refunds:review", "store_scope"],
        "x-test-case-ids": ["ADM-REFUND-*", "MCH-PORTAL-*"],
    },
    "AdminRefund_Decide": {
    ...
    "AdminRefund_List": {
        ...
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["refunds:read"],
        "x-requirement-id": ["ADM-REFUND-LIST-01", "MCH-ORDER-01", "MCH-REFUND-LIST-01"],
        "x-scope-policy": [
            "stores:read",
            "orders:read",
            "shipments:create",
    ...
    "AdminRoleGrantEvent_List": {
        ...
        "x-test-case-ids": ["ADM-ORDER-*", "ADM-RBAC-*", "ADM-SENSITIVE-*", "ADM-USER-STATUS-*"],
    },
    ...
    "AdminStoreRevenue_Get": {
        "x-audit-event": "access.AdminStoreRevenue_Get",
        "x-domain-command": "none",
        "x-idempotency-policy": "safe_read",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["stores:read"],
    ...
    "AdminStore_Create": {
        "x-audit-event": "command.AdminStore_Create",
        "x-domain-command": "AdminStore_Create",
        "x-idempotency-policy": "idempotency_key_required",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["stores:manage"],
    ...
    "AdminStore_Delete": {
        "x-audit-event": "command.AdminStore_Delete",
        "x-domain-command": "AdminStore_Delete",
        "x-idempotency-policy": "if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["stores:manage"],
        "x-requirement-id": ["ADM-STORE-DETAIL-01"],
    ...
    "AdminUserAddress_Create": {
        "x-audit-event": "command.AdminUserAddress_Create",
        "x-domain-command": "AdminUserAddress_Create",
        "x-idempotency-policy": "idempotency_key_required",
        "x-owner-kind": ["vue_route"],
    ...
    "AdminUserAddress_Delete": {
        "x-audit-event": "command.AdminUserAddress_Delete",
        "x-domain-command": "AdminUserAddress_Delete",
        "x-idempotency-policy": "if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUserAddress_List": {
        "x-audit-event": "access.AdminUserAddress_List",
        "x-domain-command": "none",
        "x-idempotency-policy": "safe_read",
        "x-owner-kind": ["vue_route"],
    ...
    "AdminUserAddress_Update": {
        "x-audit-event": "command.AdminUserAddress_Update",
        "x-domain-command": "AdminUserAddress_Update",
        "x-idempotency-policy": "if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUserCartItem_Delete": {
        "x-audit-event": "command.AdminUserCartItem_Delete",
        "x-domain-command": "AdminUserCartItem_Delete",
        "x-idempotency-policy": "if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUserCartItem_Update": {
        "x-audit-event": "command.AdminUserCartItem_Update",
        "x-domain-command": "AdminUserCartItem_Update",
        "x-idempotency-policy": "if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUserCart_Get": {
        "x-audit-event": "access.AdminUserCart_Get",
        "x-domain-command": "none",
        "x-idempotency-policy": "safe_read",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:read"],
    ...
    "AdminUserFavoriteProduct_Delete": {
        "x-audit-event": "command.AdminUserFavoriteProduct_Delete",
        "x-domain-command": "AdminUserFavoriteProduct_Delete",
        "x-idempotency-policy": "http_method_idempotent",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUserFavoriteProduct_List": {
        "x-audit-event": "access.AdminUserFavoriteProduct_List",
        "x-domain-command": "none",
        "x-idempotency-policy": "safe_read",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:read"],
    ...
    "AdminUserFollowedStore_Delete": {
        "x-audit-event": "command.AdminUserFollowedStore_Delete",
        "x-domain-command": "AdminUserFollowedStore_Delete",
        "x-idempotency-policy": "http_method_idempotent",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUserFollowedStore_List": {
        "x-audit-event": "access.AdminUserFollowedStore_List",
        "x-domain-command": "none",
        "x-idempotency-policy": "safe_read",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:read"],
    ...
    "AdminUserOrder_CancelAsUser": {
        "x-audit-event": "command.AdminUserOrder_CancelAsUser",
        "x-domain-command": "AdminUserOrder_CancelAsUser",
        "x-idempotency-policy": "idempotency_key_required+if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUserOrder_ConfirmReceiptAsUser": {
        "x-audit-event": "command.AdminUserOrder_ConfirmReceiptAsUser",
        "x-domain-command": "AdminUserOrder_ConfirmReceiptAsUser",
        "x-idempotency-policy": "idempotency_key_required+if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUserPassword_Replace": {
        "x-audit-event": "command.AdminUserPassword_Replace",
        "x-domain-command": "AdminUserPassword_Replace",
        "x-idempotency-policy": "idempotency_key_required",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:force_password_reset"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUserWallet_Adjust": {
        "x-audit-event": "command.AdminUserWallet_Adjust",
        "x-domain-command": "AdminUserWallet_Adjust",
        "x-idempotency-policy": "idempotency_key_required",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUserWorkspace_Get": {
        "x-audit-event": "access.AdminUserWorkspace_Get",
        "x-domain-command": "none",
        "x-idempotency-policy": "safe_read",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:read"],
    ...
    "AdminUser_Create": {
        "x-audit-event": "command.AdminUser_Create",
        "x-domain-command": "AdminUser_Create",
        "x-idempotency-policy": "idempotency_key_required",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-LIST-01"],
        "x-scope-policy": ["users:read", "users:manage"],
        "x-test-case-ids": ["ADM-USER-*"],
    },
    "AdminUser_Delete": {
        "x-audit-event": "command.AdminUser_Delete",
        "x-domain-command": "AdminUser_Delete",
        "x-idempotency-policy": "if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AdminUser_Update": {
        "x-audit-event": "command.AdminUser_Update",
        "x-domain-command": "AdminUser_Update",
        "x-idempotency-policy": "if_match_required_by_domain",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["users:manage"],
        "x-requirement-id": ["ADM-USER-01"],
    ...
    "AuthSession_ListMine": {
        ...
        "x-scope-policy": ["current_user"],
        "x-test-case-ids": ["FILE-UPLOAD-*", "PROFILE-*", "SECURITY-*"],
    },
    "AuthSession_Resume": {
    ...
    "FileUploadPolicy_Get": {
        ...
        "x-owner-kind": ["global_ui", "vue_route"],
        "x-permission-codes": [],
        "x-requirement-id": ["GLOBAL-FILE-UPLOAD-01", "MCH-STORE-01", "USR-SECURITY-01"],
        "x-scope-policy": [
            "current_user",
            "stores:read",
            "stores:manage",
            "store_owner",
            "purpose_owner_status_and_scope",
        ],
        "x-test-case-ids": [
            "ADM-STORE-*",
            "FILE-UPLOAD-*",
    ...
    "MerchantAccountEmail_Replace": {
        "x-audit-event": "command.MerchantAccountEmail_Replace",
        "x-domain-command": "MerchantAccountEmail_Replace",
        "x-idempotency-policy": "idempotency_key_required",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
    ...
    "MerchantAccountPassword_Replace": {
        "x-audit-event": "command.MerchantAccountPassword_Replace",
        "x-domain-command": "MerchantAccountPassword_Replace",
        "x-idempotency-policy": "idempotency_key_required",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
        "x-requirement-id": ["MCH-STORE-01"],
    ...
    "MerchantAuth_Reauthenticate": {
        ...
        "x-owner-kind": ["internal_only"],
        "x-permission-codes": [],
        "x-requirement-id": ["MCH-AUTH-COMPAT-01"],
        "x-scope-policy": ["merchant_session"],
        "x-test-case-ids": ["MCH-PORTAL-*"],
    },
    "MerchantAuth_Register": {
        "x-audit-event": "command.MerchantAuth_Register",
        "x-domain-command": "MerchantAuth_Register",
        "x-idempotency-policy": "resource_creation_no_automatic_retry",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
        "x-requirement-id": ["MCH-AUTH-01"],
    ...
    "MerchantExclusiveConversation_DeleteMine": {
        ...
        "x-domain-command": "MerchantExclusiveConversation_DeleteMine",
        "x-idempotency-policy": "http_method_idempotent",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
    ...
    "MerchantExclusiveConversation_PutMine": {
        ...
        "x-domain-command": "MerchantExclusiveConversation_PutMine",
        "x-idempotency-policy": "http_method_idempotent",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
        "x-requirement-id": ["MCH-MSG-01", "MCH-PRODUCT-LIST-01"],
        "x-scope-policy": [
            "stores:read",
            "products:read",
            "products:update",
    ...
    "MerchantExclusiveMessage_CreateMine": {
        ...
        "x-domain-command": "MerchantExclusiveMessage_CreateMine",
        "x-idempotency-policy": "payload_client_message_id_deduplication",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
        "x-requirement-id": ["MCH-MSG-01", "MCH-PRODUCT-LIST-01"],
    ...
    "MerchantStoreRevenue_Get": {
        ...
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
        "x-requirement-id": ["MCH-ORDER-01", "MCH-STORE-01"],
        "x-scope-policy": [
            "stores:read",
            "orders:read",
            "shipments:create",
    ...
    "PasswordResetHint_Get": {
        ...
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
        "x-requirement-id": ["MCH-AUTH-01", "USR-AUTH-FORGOT-01"],
        "x-scope-policy": ["user_audience", "store_operator_with_store_scope"],
        "x-test-case-ids": ["AUTH-CAPTCHA-*", "AUTH-RESET-*", "MCH-PORTAL-*"],
    },
    ...
    "PasswordReset_Complete": {
        ...
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
        "x-requirement-id": ["MCH-AUTH-01", "USR-AUTH-RESET-01"],
        "x-scope-policy": ["ticket_owner", "store_operator_with_store_scope"],
        "x-test-case-ids": ["AUTH-CAPTCHA-*", "AUTH-RESET-*", "MCH-PORTAL-*"],
    },
    ...
    "RegistrationConfig_Get": {
        ...
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
        "x-requirement-id": ["MCH-AUTH-01", "USR-AUTH-REGISTER-01"],
        "x-scope-policy": ["user_audience", "store_operator_with_store_scope"],
        "x-test-case-ids": ["AUTH-CAPTCHA-*", "AUTH-REGISTER-*", "AUTH-RESET-*", "MCH-PORTAL-*"],
    },
    "Registration_Create": {
    ...
    "SupportConversationMessage_Send": {
        ...
        "x-requirement-id": ["ADM-MSG-01", "ADM-SUPPORT-01", "MCH-MSG-01", "MCH-SUPPORT-01"],
        "x-scope-policy": [
            "support:queue_read",
            "support:claim",
            "support:reply",
    ...
    "SupportConversation_Delete": {
        ...
        "x-domain-command": "SupportConversation_Delete",
        "x-idempotency-policy": "http_method_idempotent",
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["support:reply"],
    ...
    "SupportTicket_List": {
        ...
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": ["support:queue_read"],
        "x-requirement-id": ["ADM-SUPPORT-LIST-01", "MCH-SUPPORT-LIST-01"],
    ...
    "UserProfile_Get": {
        ...
        "x-owner-kind": ["vue_route"],
        "x-permission-codes": [],
        "x-requirement-id": ["USR-PROFILE-01", "USR-SECURITY-01"],
        "x-scope-policy": ["current_user"],
        "x-test-case-ids": ["FILE-UPLOAD-*", "PROFILE-*", "SECURITY-*"],
    },
    "UserProfile_Patch": {
