...
<template><form aria-labelledby="reset-title" @submit.prevent="submit"><p class="eyebrow">账号安全</p><h1 id="reset-title">设置新密码</h1>
  ...
  <label>新密码<input v-model="password" autocomplete="new-password" minlength="15" required type="password" /></label><label>确认新密码<input v-model="confirmation" autocomplete="new-password" required type="password" /></label>
