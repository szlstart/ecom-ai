...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/admin', component: () => import('@/layouts/AdminLayout.vue'), meta: { ...adminMeta, title: '管理后台', requirementId: 'ADM-SHELL-01' }, children: [
    ...
    { path: 'ai/tools/:toolId', component: () => import('@/pages/admin/AdminToolPage.vue'), meta: { ...adminMeta, title: 'MCP Tool 详情', requirementId: 'ADM-AI-01', requiredPermission: 'ai_tools:read' } },
