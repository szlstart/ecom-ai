...
const routes: RouteRecordRaw[] = [
  { path: '/', component: () => import('@/layouts/StorefrontLayout.vue'), meta: { layout: 'storefront', audience: 'public', requiresAuth: false, title: '在线商城', requirementId: 'USR-HOME-01' }, children: [
    ...
    { path: 'messages', component: () => import('@/pages/UserMessagesPage.vue'), meta: { ...userMeta, title: '消息', requirementId: 'USR-MSG-01' } },
    { path: 'messages/:conversationId', component: () => import('@/pages/UserMessagesPage.vue'), meta: { ...userMeta, title: '会话', requirementId: 'USR-MSG-02' } },
  ...
  { path: '/merchant', component: () => import('@/layouts/MerchantGatewayLayout.vue'), meta: { layout: 'merchant-auth', audience: 'merchant', requiresAuth: false, title: '商家登录与注册', requirementId: 'MCH-AUTH-01' }, children: [
    ...
    { path: 'messages', component: () => import('@/pages/merchant/MerchantMessagesPage.vue'), meta: { ...merchantMeta, title: '消息', requirementId: 'MCH-MSG-01', requiredPermission: 'support:queue_read' } },
    ...
    { path: 'after-sales', component: () => import('@/pages/merchant/MerchantAfterSaleListPage.vue'), meta: { ...merchantMeta, title: '售后处理', requirementId: 'MCH-REFUND-LIST-01', requiredPermission: 'refunds:read' } },
    { path: 'after-sales/:refundId', component: () => import('@/pages/merchant/MerchantAfterSaleDetailPage.vue'), meta: { ...merchantMeta, title: '售后详情', requirementId: 'MCH-REFUND-01', requiredPermission: 'refunds:read' } },
  ...
  { path: '/admin', component: () => import('@/layouts/AdminLayout.vue'), meta: { ...adminMeta, title: '管理后台', requirementId: 'ADM-SHELL-01' }, children: [
    ...
    { path: 'messages', component: () => import('@/pages/admin/AdminMessagesPage.vue'), meta: { ...adminMeta, title: '消息', requirementId: 'ADM-MSG-01', requiredPermission: 'support:queue_read' } },
    ...
    { path: 'stores/:storeId/products/:productId', component: () => import('@/pages/merchant/MerchantProductEditorPage.vue'), meta: { ...adminMeta, title: '直接编辑店铺商品', requirementId: 'ADM-STORE-PRODUCT-EDIT-01', requiredPermission: 'products:read' } },
    ...
    { path: 'products/new', component: () => import('@/pages/merchant/MerchantProductEditorPage.vue'), meta: { ...adminMeta, title: '新建商品', requirementId: 'ADM-PRODUCT-NEW-01', requiredPermission: 'products:create' } },
    ...
    { path: 'products/:productId', component: () => import('@/pages/merchant/MerchantProductEditorPage.vue'), meta: { ...adminMeta, title: '商品所见即所得编辑', requirementId: 'ADM-PRODUCT-01', requiredPermission: 'products:read' } },
