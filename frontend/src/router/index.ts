...
const routes: RouteRecordRaw[] = [
  { path: '/', component: () => import('@/layouts/StorefrontLayout.vue'), meta: { layout: 'storefront', audience: 'public', requiresAuth: false, title: '在线商城', requirementId: 'USR-HOME-01' }, children: [
    ...
    { path: 'messages', component: () => import('@/pages/ConversationListPage.vue'), meta: { ...userMeta, title: '消息', requirementId: 'USR-MESSAGE-LIST-01' } },
    { path: 'messages/:conversationId', component: () => import('@/pages/ConversationPage.vue'), meta: { ...userMeta, title: '会话', requirementId: 'USR-MESSAGE-01' } },
    ...
    { path: 'me/orders/:orderId/logistics', name: 'my-order-logistics', component: () => import('@/pages/me/OrderLogisticsPage.vue'), meta: { ...userMeta, title: '订单物流', requirementId: 'USR-LOGISTICS-01' } },
    { path: 'me/shipments/:shipmentId', component: () => import('@/pages/me/ShipmentDetailPage.vue'), meta: { ...userMeta, title: '物流详情', requirementId: 'USR-LOGISTICS-02' } },
    ...
    { path: 'me/appeals/:appealId', component: () => import('@/pages/me/RefundAppealPage.vue'), meta: { ...userMeta, title: '售后申诉', requirementId: 'USR-REFUND-05' } },
  ...
  { path: '/admin', component: () => import('@/layouts/AdminLayout.vue'), meta: { ...adminMeta, title: '管理后台', requirementId: 'ADM-SHELL-01' }, children: [
    ...
    { path: 'ai/tools', component: () => import('@/pages/admin/AdminToolPage.vue'), meta: { ...adminMeta, title: 'MCP Tool 管理', requirementId: 'ADM-AI-01', requiredPermission: 'ai_tools:read' } },
    ...
    { path: 'knowledge/documents', component: () => import('@/pages/admin/AdminKnowledgePage.vue'), meta: { ...adminMeta, title: '知识库', requirementId: 'ADM-KNOW-01', requiredPermission: 'knowledge:read' } },
    { path: 'knowledge/documents/:documentId', component: () => import('@/pages/admin/AdminKnowledgePage.vue'), meta: { ...adminMeta, title: '知识文档', requirementId: 'ADM-KNOW-01', requiredPermission: 'knowledge:read' } },
    { path: 'knowledge/indexing-jobs', component: () => import('@/pages/admin/AdminJobListPage.vue'), meta: { ...adminMeta, title: '知识索引任务', requirementId: 'ADM-KNOW-JOB-01', requiredPermission: 'knowledge:read' } },
    ...
    { path: 'content/new', component: () => import('@/pages/admin/AdminContentEditPage.vue'), meta: { ...adminMeta, title: '新建平台内容', requirementId: 'ADM-CONTENT-01', requiredPermission: 'content:manage' } },
